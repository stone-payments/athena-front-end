$(function() {
  ...
  $("#find").click(function() {
    ...
    $.ajax({
      url: host + '/get_org_info?name=' + name,
      type: 'GET',
      success: function(response) {
        returnedData = JSON.parse(response);
    ...
    $.ajax({
      url: host + '/get_languages_org?name=' + name,
      type: 'GET',
      success: function(response) {
        returnedData = JSON.parse(response);
    ...
    $.ajax({
      url: host + '/get_commits_org?name=' + name + '&startDate=' + startDay + '&endDate=' + lastDay,
      type: 'GET',
      success: function(response) {
        returnedData = JSON.parse(response);
    ...
    $.ajax({
      url: host + '/get_open_source_org?name=' + name,
      type: 'GET',
      success: function(response) {
        returnedData = JSON.parse(response);
        let labelsCommit = returnedData.map(function(num) {
    ...
    $.ajax({
      url: host + '/get_readme_org?name=' + name,
      type: 'GET',
      success: function(response) {
        returnedData = JSON.parse(response);
    ...
    $.ajax({
      url: host + '/get_open_source_readme_org?name=' + name,
      type: 'GET',
      success: function(response) {
        returnedData = JSON.parse(response);
        let labelsReadme = returnedData.map(function(num) {
    ...
    $.ajax({
      url: host + '/get_license_type_org?name=' + name,
      type: 'GET',
      success: function(response) {
        returnedData = JSON.parse(response);
    ...
    $.ajax({
      url: host + '/get_issues_org?name=' + name + '&startDate=' + startDay + '&endDate=' + lastDay,
      type: 'GET',
      success: function(response) {
        returnedData = JSON.parse(response);
